...
export const capabilities: Record<EditionId, Capability[]> = {
  ...
  harness: [
    { id: 'serverless-functions', name: 'Serverless compute', hue: 'invocation', summary: 'Runs agent code on demand, as functions or containers, without managing servers.', products: ['lambda', 'modal'] },
    { id: 'container-image', name: 'Container images', hue: 'execution', summary: 'Builds and runs OCI images that package agent code and dependencies.', products: ['docker'] },
    { id: 'container-orchestration', name: 'Container orchestration', hue: 'execution', summary: 'Schedules and keeps long-running workers alive.', products: ['kubernetes'] },
    { id: 'relational-state', name: 'Relational store', hue: 'state', summary: 'Durable records of runs, tasks, and results.', products: ['postgresql'] },
    { id: 'fast-state', name: 'In-memory store', hue: 'state', summary: 'Low-latency session state, queues, and caches.', products: ['redis'] },
    { id: 'llm-tracing', name: 'LLM tracing', hue: 'observability', summary: 'Traces prompts, tool calls, cost, and quality per run.', products: ['langfuse'] },
    { id: 'telemetry-standard', name: 'Telemetry standard', hue: 'observability', summary: 'Vendor-neutral traces, metrics, and logs over OTLP. Not a storage or UI backend itself.', products: ['opentelemetry'] },
    { id: 'durable-workflow', name: 'Durable workflow', hue: 'resilience', summary: 'Retries and resumes multi-step work across failures.', products: ['temporal'] },
    { id: 'distributed-compute', name: 'Distributed compute', hue: 'scaling', summary: 'Spreads work across many workers and machines.', products: ['ray'] },
    { id: 'secrets', name: 'Secrets manager', hue: 'security', summary: 'Stores and issues credentials instead of embedding them.', products: ['vault'] },
  ],
}
