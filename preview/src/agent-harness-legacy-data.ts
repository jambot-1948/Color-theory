// Frozen copy of the original seven-role harness data, kept only for the legacy AgentHarnessChromatics view.
// The current edition lives in agent-harness-chromatics-data.ts.
export type AHHueId =
  | "invocation"
  | "execution"
  | "state"
